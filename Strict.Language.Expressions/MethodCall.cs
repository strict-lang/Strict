    ...
    public class MethodCall : Expression
    {
        ...
        private static Expression? TryParseMethod(Method context, params string[] parts)
        {
            ...
            if (!methodName.Contains('.'))
                return GetMethodCall(new MemberCall(context.GetMember(methodName)),
                    context.Type, methodName, GetArguments(context, parts, methodName));
        ...
        private static Expression? GetMethodCall(Expression instance, Type context,
        ...
        private static Expression[] GetArguments(Method context, string[] parts,
            string methodName)
        {
