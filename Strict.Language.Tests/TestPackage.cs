	...
	public TestPackage() : base(nameof(TestPackage))
	{
		...
		var types = new[] {
			...
			new Type(this, new TypeLines(Base.Iterator,
				"for Iterator(Generic)", "in(element Generic) Boolean",
				"Length Number")),
			new Type(this, new TypeLines(Base.List,
				...
				"\t1 in(5, 6) is 5",
				"\telement(0)",
				"Add(element Generic) Mutable(Generics)",
				"\t(1, 2).Add(3) is (1, 2, 3)",
				"\tvalue = value + element",
				"Remove(element Generic) Mutable(Generics)",
			...
			new Type(this, new TypeLines(Base.Text,
				...
				"in(elements Iterator(Generic))",
				"\telements(0)")),
			new Type(this, new TypeLines(Base.Type, "has Name",
				"has Package Text",
				"to Text",
