	...
	public TestPackage() : base(nameof(TestPackage))
	{
		...
		var types = new[] {
			...
			new Type(this, new TypeLines(Base.Iterator,
				//TODO: Revert when trait feature is fixed "for Generic", "in(element Generic) Boolean",
				"Length Number")),
			...
			new Type(this, new TypeLines(Base.Output, "Write(generic)")),
				//TODO: Use this method new Type(this, new TypeLines(Base.Name, "has text(not \" \")")),
				new Type(this, new TypeLines(Base.Name, "has text", "Run")),
