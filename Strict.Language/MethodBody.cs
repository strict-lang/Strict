...
namespace Strict.Language
{
	...
	/// all executed and then the final result is returned. Method parameters are also passed into
	/// this context and can be used by any of the expressions nested here.
	/// </summary>
