...
namespace Strict.Language
{
    ...
    public class Repositories
    {
        ...
        {
            if (packageUrl.Host != "github.com" ||
                string.IsNullOrEmpty(packageUrl.AbsolutePath) ||
            ...
            Package? parent)
        {
            ...
            foreach (var filePath in files)
                types.Add(new Type(package, Path.GetFileNameWithoutExtension(filePath),
                    parser));
        ...
        private static string DevelopmentFolder =>
            Path.Combine(@"C:\code\GitHub\strict-lang");
